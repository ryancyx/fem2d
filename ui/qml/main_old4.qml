    ...
    ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                HeaderActionButton {
                                    text: "材料"
                                    onClicked: { rightPanelVisible = true; shell_status = "请在右侧属性编辑器的材料管理区中编辑材料" }
                                }

                                HeaderActionButton {
                                    text: "约束"
                                    onClicked: { rightPanelVisible = true; shell_status = "请先选中节点，再在右侧约束区中设置位移约束" }
                                }

                                HeaderActionButton {
                                    text: "载荷"
                                    onClicked: { rightPanelVisible = true; shell_status = "请先选中节点，再在右侧载荷区中设置节点载荷" }
                                }
                            }
                        }
        ...
        SplitView {
            ...
            Rectangle {
                ...
                SplitView.minimumWidth: leftPanelVisible ? 300 : 0
                SplitView.preferredWidth: leftPanelVisible ? 330 : 0
                color: bgPanel2
                border.color: borderColor
...
Rectangle {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                radius: 4
                color: dataListPanel.currentListTab === 0 ? accentSoft : "#f4f6f9"
                border.color: dataListPanel.currentListTab === 0 ? accent : "#d7dee6"
                implicitWidth: 92
                implicitHeight: 28

                MouseArea {
                    anchors.fill: parent
                    onClicked: dataListPanel.currentListTab = 0
                }

                Label {
                    anchors.centerIn: parent
                    text: "节点 (" + nodeListModel.count + ")"
                    color: dataListPanel.currentListTab === 0 ? accent : textMain
                    font.pixelSize: 12
                    font.bold: dataListPanel.currentListTab === 0
                }
            }

            Rectangle {
                radius: 4
                color: dataListPanel.currentListTab === 1 ? accentSoft : "#f4f6f9"
                border.color: dataListPanel.currentListTab === 1 ? accent : "#d7dee6"
                implicitWidth: 92
                implicitHeight: 28

                MouseArea {
                    anchors.fill: parent
                    onClicked: dataListPanel.currentListTab = 1
                }

                Label {
                    anchors.centerIn: parent
                    text: "单元 (" + elementRowsCache.length + ")"
                    color: dataListPanel.currentListTab === 1 ? accent : textMain
                    font.pixelSize: 12
                    font.bold: dataListPanel.currentListTab === 1
                }
            }
        }
        ...
        StackLayout {
            Layout.fillWidth: true
            Layout.fillHeight: true
            currentIndex: dataListPanel.currentListTab
            ...
            Rectangle {
                ...
                SplitView.preferredWidth: rightPanelVisible ? 350 : 0
                color: bgPanel2
                border.color: borderColor
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        TextField {
                                            ...
                                            Layout.fillWidth: true
                                            enabled: appController.selected_node_exists && constraintUxCheck.checked
                                            placeholderText: "Ux 约束值"
                                        }
                                    }
                                    ...
                                    RowLayout {
                                        ...
                                        TextField {
                                            ...
                                            Layout.fillWidth: true
                                            enabled: appController.selected_node_exists && constraintUyCheck.checked
                                            placeholderText: "Uy 约束值"
                                        }
                                    }
                                    ...
                                    Label { text: "材料名称"; color: textMuted }
                                    ...
                                    Label { text: "为当前单元分配材料"; color: textMuted }
                                    ...
                                    Rectangle {
                                        ...
                                        ListView {
                                            ...
                                            delegate: Rectangle {
                                                ...
                                                height: 38
                                                radius: 4
                                                border.color: modelData.material_id === selectedMaterialIdForEdit ? accent : "#d7dee6"
                                                color: modelData.material_id === selectedMaterialIdForEdit ? accentSoft : (index % 2 === 0 ? "#fcfdff" : "#f6f9fc")

                                                MouseArea {
                                                    anchors.fill: parent
                                                    onClicked: {
                                                        fillMaterialEditor(modelData.material_id)
                                                        shell_status = "已选中材料 " + modelData.material_id
                                                    }
                                                }
                                    ...
                                    TextField {
                                        id: materialEField
                                        Layout.fillWidth: true
                                        placeholderText: "例如：210000000000"
                                    }
