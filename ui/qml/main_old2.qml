...
ApplicationWindow {
    ...
    function openContourOverlay(modeName) {
        ...
        contourTitle = modeName === "von_mises" ? "Von Mises 应力云图" : "位移云图"
        updateContourRange()
                            ...
                            ColumnLayout {
                                ...
                                Rectangle {
                                    ...
                                    ColumnLayout {
                                        ...
                                        Label {
                                            Layout.fillWidth: true
                                            text: appController.solver_has_result ? "打开临时云图窗口，不影响主视口。" : "求解完成后可打开云图。"
                                            color: textMuted
                                            font.pixelSize: 11
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                Layout.fillWidth: true
                                text: contourMode === "von_mises" ? "节点值为相邻单元 Von Mises 平均值" : "节点位移模长插值"
                                color: textMuted
                                font.pixelSize: 10
                                wrapMode: Text.WordWrap
                            }
